    ...
    <div className="space-y-6 text-sm text-slate-700 dark:text-slate-300">
      <section>
        <h3 className="font-semibold text-slate-900 dark:text-slate-100 mb-2 flex items-center gap-2">
          ...
          Как посадить культуру
        </h3>
        <p className="pl-7">
          Нажмите <strong>«Посадить культуру»</strong>. Выберите культуру и сорт, затем укажите <strong>место посадки</strong>: дома, теплица, открытый грунт или высокая грядка. Место влияет на рекомендации, погоду и шкалу роста, но отдельную грядку вручную создавать не нужно.
        </p>
      </section>
      ...
      <section>
        <h3 className="font-semibold text-slate-900 dark:text-slate-100 mb-2 flex items-center gap-2">
          ...
          Как выбрать культуру
        </h3>
        <p className="pl-7 mb-2">
          Есть два способа выбора культуры:
        </p>
      ...
      <section>
        ...
        <ul className="pl-7 list-disc space-y-1 ml-2">
          ...
          <li>
            <span className="inline-flex items-center gap-1"><span className="w-2.5 h-2.5 rounded-full bg-blue-500" /> Синие</span> — фото растения с вердиктом «всё в норме». Нажмите — увидите краткий вывод Агроэксперта.
          </li>
          <li>
      ...
      <section>
        ...
        <ul className="pl-7 list-disc space-y-1 ml-2">
          ...
          <li>Существующие грядки остаются доступными: их можно открыть, переименовать и использовать как раньше.</li>
          <li>Удаление: кнопка с иконкой корзины у растения или у пользовательской грядки.</li>
        </ul>
      </section>
    </div>
  );
