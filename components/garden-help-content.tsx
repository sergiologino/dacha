  ...
  return (
    <div className="space-y-6 text-sm text-slate-700 dark:text-slate-300">
      ...
      <section>
        ...
        <p className="pl-7 mb-2">
          У каждого растения есть кнопка с иконкой <strong>камеры</strong>. Нажмите её — можно сделать снимок или выбрать фото с устройства. После загрузки приложение отправит фото нейросети с учётом даты посадки, названия культуры и места выращивания.
        </p>
        <p className="pl-7 mb-2">
