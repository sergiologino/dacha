...
const SLIDES: {
...
}[] = [
  {
    ...
    text: "Планируйте посадки, уход и урожай в одном месте. Мы уже добавили для вас пример — культуру в теплице с планом ухода. Если понадобится помощь или хотите подсказать идею, напишите нам в Telegram или MAX — кнопки есть в шапке приложения.",
