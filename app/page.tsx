...
export const metadata: Metadata = {
  ...
  description:
    "Календарь посадок по регионам России, сроки посева рассады, лунный календарь и фото-анализ болезней растений. Приложение для дачников и садоводов.",
  keywords:
  ...
  openGraph: {
    ...
    description:
      "Сроки посева рассады, подсказки по регионам, лунный календарь и фото-анализ болезней растений.",
    type: "website",
    locale: "ru_RU",
    url: absoluteUrl("/"),
