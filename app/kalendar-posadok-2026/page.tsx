    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-amber-50 dark:from-emerald-950 dark:via-slate-950 dark:to-amber-950">
      ...
      <div className="mx-auto max-w-5xl px-4 py-10">
        ...
        <p className="mt-4 max-w-3xl text-lg leading-8 text-slate-600 dark:text-slate-300">
          Это краткий помесячный ориентир для дачного сезона: что обычно сеют на рассаду,
          что высаживают в теплицу и в открытый грунт и какие работы важны весной, летом и осенью.
          Используйте календарь как основу, а окончательные сроки сверяйте по погоде вашего региона.
        </p>
