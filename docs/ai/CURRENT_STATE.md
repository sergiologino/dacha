...
- [x] **Настройки** `/settings` — редактирование координат на карте, выход, включение Web Push-уведомлений по работам на сегодня и завтра
...
- [~] Push-уведомления — базовые Web Push по работам на сегодня/завтра уже есть (из календаря ухода и добавленным вручную), погода и расширенные сценарии ещё впереди
- [ ] Галерея с sharing
